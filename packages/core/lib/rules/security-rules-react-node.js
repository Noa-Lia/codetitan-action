...
const REACT_NODE_RULES = {
  ...
  REACT: {
    dangerouslySetInnerHTML: {
      ...
      cwe: "CWE-79",
      message:
        "dangerouslySetInnerHTML bypasses React XSS protection - sanitize with DOMPurify",
    },
    unsafeLifecycleMethod: {
      ...
      cwe: "CWE-749",
      message:
        "Unsafe lifecycle method UNSAFE_componentWillMount/Update - migrate to hooks",
    },
    findDOMNode: {
      severity: "LOW",
      impact: 3,
    ...
    stateDirectMutation: {
      ...
      cwe: "CWE-362",
      message:
        "Direct state mutation detected - use setState or useState setter",
    },
    missingKeyProp: {
      severity: "LOW",
      impact: 2,
    ...
    propsSpread: {
      ...
      cwe: "CWE-915",
      message:
        "Spreading props may pass unexpected values - destructure explicitly",
    },
    evalInJSX: {
      severity: "CRITICAL",
      impact: 10,
  ...
  EXPRESS: {
    noHelmet: {
      ...
      cwe: "CWE-693",
      message:
        "Express app without helmet middleware - add helmet() for security headers",
    },
    noCSRF: {
      severity: "HIGH",
      impact: 8,
    ...
    sessionInsecure: {
      ...
      cwe: "CWE-614",
      message:
        "Session cookie without secure flag - add secure: true in production",
    },
    bodyParserLimit: {
      severity: "MEDIUM",
      impact: 5,
      cwe: "CWE-400",
      message:
        "Body parser without size limit - add limit option to prevent DoS",
    },
    staticPath: {
      severity: "MEDIUM",
      impact: 6,
      cwe: "CWE-22",
      message:
        "express.static with user path - validate path to prevent traversal",
    },
    errorExposure: {
      severity: "MEDIUM",
      impact: 5,
    ...
    trustProxy: {
      ...
      cwe: "CWE-346",
      message:
        "trust proxy not configured - set for correct client IP behind proxy",
    },
    routeWildcard: {
      severity: "LOW",
      impact: 3,
  ...
  NODE: {
    ...
    unsafeUnserialize: {
      ...
      cwe: "CWE-502",
      message:
        "node-serialize/unserialize is vulnerable to RCE - remove immediately",
    },
    bufferNoEncoding: {
      severity: "LOW",
      impact: 3,
      cwe: "CWE-838",
      message:
        "Buffer without encoding may cause issues - specify encoding explicitly",
    },
    requireDynamic: {
      severity: "HIGH",
      impact: 7,
      cwe: "CWE-94",
      message:
        "require() with dynamic path - may allow arbitrary module loading",
    },
    fsPermissions: {
      severity: "MEDIUM",
      impact: 5,
      cwe: "CWE-732",
      message:
        "File created with permissive mode - use restrictive permissions",
    },
    childProcessShell: {
      severity: "CRITICAL",
      impact: 10,
      cwe: "CWE-78",
      message:
        "child_process with shell=true - vulnerable to command injection",
    },
    httpCreateServer: {
      severity: "MEDIUM",
      impact: 5,
    ...
    noTimeout: {
      ...
      cwe: "CWE-400",
      message:
        "Server without request timeout - add timeout to prevent slowloris",
    },
    uncaughtException: {
      severity: "MEDIUM",
      impact: 5,
  ...
  DATABASE: {
    ...
    mongoURI: {
      ...
      cwe: "CWE-798",
      message:
        "MongoDB URI with credentials in code - use environment variable",
    },
    pgSSL: {
      severity: "HIGH",
      impact: 7,
  ...
  NEXTJS: {
    ...
    envExposure: {
      ...
      cwe: "CWE-200",
      message:
        "Server env exposed to client - use NEXT_PUBLIC_ prefix only for public vars",
    },
    rscPayload: {
      severity: "MEDIUM",
      impact: 5,
