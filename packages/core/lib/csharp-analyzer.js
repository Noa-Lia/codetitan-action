...
const CSHARP_SECURITY_RULES = {
  ...
  SQL_INJECTION: {
    ...
    message:
      "Potential SQL injection - use parameterized queries or Entity Framework LINQ",
    cwe: "CWE-89",
  },
  ...
  PATH_TRAVERSAL: {
    ...
    message:
      "Potential path traversal - use Path.GetFullPath and validate against base directory",
    cwe: "CWE-22",
  },
  ...
  INSECURE_DESERIALIZATION: {
    ...
    message:
      "Insecure deserialization - avoid BinaryFormatter, use safe JSON settings",
    cwe: "CWE-502",
  },
  ...
  HARDCODED_SECRET: {
    ...
    message:
      "Hardcoded secret detected - use User Secrets, Azure Key Vault, or environment variables",
    cwe: "CWE-798",
  },
  ...
  // Insecure Random
  INSECURE_RANDOM: {
    patterns: [/new\s+Random\s*\(\s*\)/, /Random\s*\(\s*\)\.Next/],
    severity: "MEDIUM",
  ...
  MASS_ASSIGNMENT: {
    ...
    message:
      "Potential mass assignment vulnerability - use DTOs or explicit binding",
    cwe: "CWE-915",
  },
