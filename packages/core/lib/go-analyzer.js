...
const GO_SECURITY_RULES = {
  ...
  SQL_INJECTION: {
    ...
    message:
      "Potential SQL injection - use parameterized queries with $1, $2...",
    cwe: "CWE-89",
  },
  ...
  COMMAND_INJECTION: {
    ...
    message:
      "Potential command injection - avoid shell wrappers, use argument arrays",
    cwe: "CWE-78",
  },
  ...
  INSECURE_TLS: {
    ...
    message:
      "Insecure TLS configuration - enable certificate verification and use TLS 1.2+",
    cwe: "CWE-295",
  },
  ...
  // Unsafe Pointer
  UNSAFE_POINTER: {
    patterns: [/unsafe\.Pointer/, /import\s+["']unsafe["']/],
    severity: "MEDIUM",
  ...
  // XML Parsing
  XXE: {
    patterns: [/xml\.NewDecoder\s*\(/, /xml\.Unmarshal\s*\(/],
    severity: "MEDIUM",
    category: "XXE",
