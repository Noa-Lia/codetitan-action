  ...
  XSS: [
    {
      ...
      severity: "HIGH",
      message:
        "mark_safe() bypasses Django XSS protection - ensure input is sanitized",
      impact: 8,
      cwe: "CWE-79",
    },
    {
  ...
  PATH_TRAVERSAL: [
    {
      ...
      severity: "HIGH",
      message:
        "File open with variable path - validate to prevent path traversal",
      impact: 8,
      cwe: "CWE-22",
    },
    {
  ...
  SSRF: [
    {
      ...
      pattern:
        /requests\.(get|post|put|delete|patch)\s*\(\s*[a-zA-Z_][a-zA-Z0-9_]*/,
      severity: "MEDIUM",
  ...
  REGEX: [
    {
      id: "REGEX_USER_INPUT",
      pattern:
        /re\.(match|search|findall|sub)\s*\(\s*[a-zA-Z_][a-zA-Z0-9_]*\s*,/,
      severity: "MEDIUM",
