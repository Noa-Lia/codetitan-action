...
const JAVA_SECURITY_RULES = {
  ...
  SQL_INJECTION: {
    ...
    message:
      "Potential SQL injection - use parameterized queries with PreparedStatement",
    cwe: "CWE-89",
  },
  ...
  PATH_TRAVERSAL: {
    ...
    message:
      "Potential path traversal - validate file paths and use canonical paths",
    cwe: "CWE-22",
  },
  ...
  XSS: {
    ...
    category: "XSS",
    message:
      "Potential XSS - encode output using OWASP encoder or JSTL escapeXml",
    cwe: "CWE-79",
  },
  ...
  XXE: {
    ...
    category: "XXE",
    message:
      "XML parser may be vulnerable to XXE - disable external entities and DTDs",
    cwe: "CWE-611",
  },
  ...
  INSECURE_DESERIALIZATION: {
    ...
    message:
      "Insecure deserialization - validate input or use safe alternatives like JSON",
    cwe: "CWE-502",
  },
  ...
  OPEN_REDIRECT: {
    ...
    message:
      "Potential open redirect - validate redirect URLs against whitelist",
    cwe: "CWE-601",
  },
  ...
  SPRING_SECURITY: {
    ...
    message:
      "Spring Security misconfiguration detected - review security settings",
    cwe: "CWE-16",
  },
  ...
  HQL_INJECTION: {
    ...
    category: "SQL_INJECTION",
    message:
      "HQL/JPQL injection - use parameterized queries with setParameter()",
    cwe: "CWE-89",
  },
      ...
      if (pattern.test(code)) {
        ...
        if (match && match.index !== undefined) {
          ...
          const alreadyFound = issues.some(
            (i) =>
              i.category === rule.category && Math.abs(i.line - lineNumber) < 3,
          );
